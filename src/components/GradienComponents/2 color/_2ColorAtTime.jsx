              ...
              <div className='G_positio2'>
                ...
                <div className='colorbtns'>
                  <div className="mainc">
                    ...
                    <div onChange={setGradient} className='C2container2'>
                      {hidden2 && (
                        <Chrome
                          color={hsva2}
                          onChange={(color) => {
                      ...
                      <button className='G_colorBtn py-4 px-4 focus:outline-none text-center me-2 mb-2' style={{ backgroundColor: hex2 }} onClick={() => setHidden2(!hidden2)}>{hex1}</button>
                    </div>
                  </div>
                </div>
