...
const Homepage = () => {
    ...
    window.scrollTo({
      top: currentScrollPosition + (viewportHeight * direction),
      behavior: 'smooth'
    });
  };
  ...
  const scrollDown = () => scrollByVH(1);
    ...
    return (
        <>
            ...
            <div className="Homepage_main pt-14 relative bg-gray-100 min-h-screen">

                <div className="container pt-36 z-10 mx-auto p-4 flex flex-col lg:flex-row items-center justify-between h-screen">
                    ...
                    <div className="lg:w-1/2 z-10 p-4 text-center lg:text-left">
                        ...
                        <div className="flex flex-col lg:flex-row gap-4 items-center justify-center ">
                            ...
                            <button  onClick={scrollDown}  className="border border-zinc-300 dark:border-blue-800 px-6 py-3 rounded-lg text-lg hover:bg-blue-200 dark:hover:bg-b-700 transition-colors">
